...
<?php $criteria = Session::get('criteria'); ?>
    <div class="theme-hero-area">
      <div class="theme-hero-area-bg-wrap">
        <div class="theme-hero-area-bg-pattern theme-hero-area-bg-pattern-ultra-light" style="background-image:url(<?php echo e(asset('frontend/img/patterns/travel/4.png')); ?> ) ;"></div>
                  ...
                  <?php if($row->id==1): ?>
                    <?php if(!empty($row->image_name)): ?>
                        <?php if(file_exists(base_path().'/img/side_bannners/'.$row->image_name)): ?>   
                            <img src="<?php echo e($row->image_url); ?>" class="img-thumb img" alt="Image Alternative text" title="Image Title" > 
                        <?php else: ?>
                             <img src="<?php echo e($row->image_url); ?>" class="theme-ad-img" alt="Image Alternative text" title="Image Title" > 
                        <?php endif; ?>
                    <?php endif; ?>
                  <?php endif; ?>
...
<script src="<?php echo e(asset('/frontend/js/additional-methods.js')); ?>"></script>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\gamarooms\resources\views/frontend/search_hotels.blade.php ENDPATH**/ ?>