...
<div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
    <div class="kt-header__brand-logo">
        <a href="<?php echo e(url('/')); ?>">
            <img alt="Logo" src="<?php echo e(asset('public/img/logo-8.png')); ?>" class="kt-header__brand-logo-default"/>
            <img alt="Logo" src="<?php echo e(asset('public/img/logo-8.png')); ?>" class="kt-header__brand-logo-sticky"/>          
        </a>        
    </div> 
</div>
<!-- end:: Brand -->            
...
<div class="kt-header__topbar">
    ...
    <div class="kt-header__topbar-item kt-header__topbar-item--user" >
        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,10px">
            ...
            <img alt="Pic" src="<?php echo e(asset('public/backend/assets/media/users/300_21.jpg')); ?>"/>         
    ...
    <div class="kt-user-card kt-user-card--skin-light kt-notification-item-padding-x">
        <div class="kt-user-card__avatar">
            <img class="kt-hidden-" alt="Pic" src="<?php echo e(asset('public/backend/assets/media/users/300_25.jpg')); ?>" />
...
<!-- end:: Header --><?php /**PATH /home/gamarpcx/public_html/resources/views/backend/layouts/header.blade.php ENDPATH**/ ?>