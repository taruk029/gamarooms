...
<div class="theme-hero-area theme-hero-area-primary">
        ...
        <div class="theme-hero-area-bg"style="background-image:url(public/assets/img/rxgcjsathdq_1500x800.jpg);"></div>
          ...
          <div class="container">
            <div class="theme-search-area _pv-100 _pv-mob-60 theme-search-area-stacked theme-search-area-white">
              ...
              <div class="theme-search-area-header">
                ...
                <center><img src="<?php echo e(asset('public/img/glogo.png')); ?>" class="img-thumb"></h1></center>
              </div>
              <div class="tabbable">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gamarpcx/public_html/resources/views/frontend/index.blade.php ENDPATH**/ ?>