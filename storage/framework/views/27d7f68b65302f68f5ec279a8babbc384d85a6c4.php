      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <p class="theme-copyright-text">Copyright © <?php echo date('Y'); ?>
              <a href="<?php echo e(url('/')); ?>">Gama Rooms</a>. All rights reserved.
            </p>
          </div>
          <div class="col-md-6">
    ...
    </div><?php /**PATH /home/gamarpcx/public_html/resources/views/frontend/layout/footer.blade.php ENDPATH**/ ?>