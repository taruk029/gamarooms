                        ...
                        <div class="row" data-gutter="10">
                          <div class="col-xs-12">
                            <div class="banner theme-about-us-section-gallery-img theme-about-us-section-gallery-img-lg banner-">
                              <div class="banner-bg" style="background-image:url(<?php echo e(asset('public/img/adult-book-business-cactus-297755_555x200.jpg')); ?>);"></div>
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="banner theme-about-us-section-gallery-img theme-about-us-section-gallery-img-lg banner-">
                              <div class="banner-bg" style="background-image:url(<?php echo e(asset('public/img/plate-flight-sky-sunset_280x205.jpg')); ?>);"></div>
                            </div>
                          </div>
                          <div class="col-xs-6">
                            <div class="banner theme-about-us-section-gallery-img theme-about-us-section-gallery-img-lg banner-">
                              <div class="banner-bg" style="background-image:url(<?php echo e(asset('public/img/woman-wearing-bikini-jumping-to-the-beach-191741_280x205.jpg')); ?>);"></div>
                            </div>
                          </div>
                        </div>
                      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gamarpcx/public_html/resources/views/frontend/aboutus.blade.php ENDPATH**/ ?>