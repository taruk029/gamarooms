...
<div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
    <div class="kt-header__brand-logo">
        <a href="<?php echo e(url('/')); ?>">
            <img alt="Logo" src="<?php echo e(asset('img/logo-8.png')); ?>" class="kt-header__brand-logo-default"/>
            <img alt="Logo" src="<?php echo e(asset('img/logo-8.png')); ?>" class="kt-header__brand-logo-sticky"/>          
        </a>        
    </div> 
</div>
<!-- end:: Brand -->            
...
<div class="kt-header__topbar">
    ...
    <div class="kt-header__topbar-item kt-header__topbar-item--user" >
        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,10px">
            ...
            <img alt="Pic" src="<?php echo e(asset('backend/assets/media/users/300_21.jpg')); ?>"/>         
    ...
    <div class="kt-user-card kt-user-card--skin-light kt-notification-item-padding-x">
        <div class="kt-user-card__avatar">
            <img class="kt-hidden-" alt="Pic" src="<?php echo e(asset('backend/assets/media/users/300_25.jpg')); ?>" />
        ...
        <div class="kt-user-card__badge">
            <a href="<?php echo e(route('logout')); ?>" class="btn btn-label btn-label-brand btn-sm btn-bold">Sign Out</a>
        </div>
    </div>
<!--end: Head -->
    </div>
...
<div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
   <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile ">
    <ul class="kt-menu__nav ">
        ...
        <li class="kt-menu__item  kt-menu__item<?php if(Request::segment(2)=="dashboard") echo "--active";  else echo"--rel"; ?> " aria-haspopup="true">
            <a href="<?php echo e(url('admin/dashboard')); ?>" class="kt-menu__link "><span class="kt-menu__link-text">Dashboard</span></a>
        </li>
        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(2)=="agents") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="<?php echo e(url('admin/agents')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Agents</span>
        </a>
        </li>
        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(2)=="wallet") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="<?php echo e(url('admin/wallet')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Wallet</span>
        </a>
        </li>
        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(2)=="bookings") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="<?php echo e(url('admin/bookings')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Bookings</span>
        </a>
        </li>
        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(2)=="media") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="<?php echo e(url('admin/media')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Media</span>
        </a>
        </li>
        <!-- <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(1)=="training") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="<?php echo e(url('training')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Training</span>
        </a>
        </li>
        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(1)=="dev_score") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="<?php echo e(url('dev_score')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Development Plan</span>
        </a>
        </li> -->
        <!-- <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(1)=="changerequest" || Request::segment(1)=="add_change_request") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="<?php echo e(url('changerequest')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Change Request</span>
        </a>
        </li> -->
        ...
        <!-- <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(1)=="companies" || Request::segment(1)=="add_company") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="<?php echo e(url('companies')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Companies</span>
        </a>
        </li> -->
        <!-- <li class="kt-menu__item kt-menu__item<?php if(Request::segment(1)=="departments" || Request::segment(1)=="add_departments") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
                <a href="<?php echo e(url('departments')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Departments</span>
                </a>
        </li>
         -->
            ...
            <div class="kt-menu__submenu kt-menu__submenu--classic">
                <ul class="kt-menu__subnav">
                    <li class="kt-menu__item  kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
                        <a href="<?php echo e(url('departments')); ?>" class="kt-menu__link">
                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                            <span class="kt-menu__link-text">Departments</span>
                        </a>
                    </li>
                    <li class="kt-menu__item  kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
                        <a href="<?php echo e(url('subdepartments')); ?>" class="kt-menu__link">
                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
        ...
        <!-- <li class="kt-menu__item kt-menu__item<?php if(Request::segment(1)=="objectives" || Request::segment(1)=="add_objective") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
                <a href="<?php echo e(url('objectives')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Goal Settings</span>
                </a>
        </li>
        <li class="kt-menu__item kt-menu__item<?php if(Request::segment(1)=="kras" || Request::segment(1)=="add_kra"|| Request::segment(1)=="add_kpi") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
                <a href="<?php echo e(url('kras')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">KRA & KPI</span>
                </a>
        </li>
        <li class="kt-menu__item kt-menu__item<?php if(Request::segment(1)=="skills" || Request::segment(1)=="add_skills") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
                <a href="<?php echo e(url('skills')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Skill</span>
                </a>
        </li> -->
        <!-- <li class="kt-menu__item kt-menu__item<?php if(Request::segment(1)=="competencies" || Request::segment(1)=="add_competency") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
                <a href="<?php echo e(url('competencies')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Competency</span>
                </a>
        </li>        
        <li class="kt-menu__item kt-menu__item<?php if(Request::segment(1)=="employees" || Request::segment(1)=="add_employee"|| Request::segment(1)=="set_skill_rating") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
                <a href="<?php echo e(url('employees')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Employees</span>
                </a>
        </li> -->
       ...
       <!--  <li class="kt-menu__item kt-menu__item<?php if(Request::segment(1)=="designations" || Request::segment(1)=="add_designation") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
                <a href="<?php echo e(url('designations')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">Designation</span>
                </a>
        </li> -->
...
<!-- end:: Header --><?php /**PATH E:\xampp\htdocs\gamarooms\resources\views/backend/layouts/header.blade.php ENDPATH**/ ?>