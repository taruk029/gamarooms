...
<!--begin::Aside-->
<div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url(<?php echo e(asset('public/backend/assets/media/demos/demo8/bg-1.jpg')); ?>);">
    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
        <div class="kt-grid__item kt-grid__item--middle">
           <a href="#" class="kt-login__logo">
            <img src="<?php echo e(asset('public/img/login-logo.png')); ?>" class="kt-header__brand-logo-default  login_logo">
        </a></div>
    </div>
    <div class="kt-grid__item">
...
<?php echo $__env->make('backend.layouts.login_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gamarpcx/public_html/resources/views/backend/login.blade.php ENDPATH**/ ?>