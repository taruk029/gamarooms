...
<head>
    ...
    <link href="<?php echo e(asset('backend/assets/vendors/custom/fullcalendar/fullcalendar.bundle.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/assets/vendors/global/vendors.bundle.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/assets/css/demo8/style.bundle.css')); ?>" rel="stylesheet" type="text/css" />
...
<!-- end::Head -->
<!-- begin::Body -->
<body style="background-image: url(<?php echo e(asset('backend/assets/media/demos/demo8/bg-1.jpg)')); ?>" class="kt-page--fluid kt-page--loading">
    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        <div class="kt-header-mobile__logo">
            <a href="<?php echo e(url('/')); ?>">
                <img alt="Logo" src="<?php echo e(asset('img/logo-8.png')); ?>" />
            </a>
        </div>
    ...
    <script src="<?php echo e(asset('backend/js/block_ui.js')); ?>"></script>    
...
<!-- end::Body -->
</html><?php /**PATH E:\xampp\htdocs\gamarooms\resources\views/backend/layouts/app.blade.php ENDPATH**/ ?>