  ...
  <body>
    ...
    <div class="theme-hero-area">
      <div class="theme-hero-area-bg-wrap">
        <div class="theme-hero-area-bg" style="background-image:url(<?php echo e(asset('frontend/img/adult-book-business-cactus-297755_1500x800.jpg' )); ?>);"></div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script src="<?php echo e(asset('frontend/js/gmap.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('frontend/js/youtube-bg.js')); ?>"></script>
...
</html><?php /**PATH E:\xampp\htdocs\gamarooms\resources\views/auth/login.blade.php ENDPATH**/ ?>