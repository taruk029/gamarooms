...
<div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
    <div class="kt-header__brand-logo">
        <a href="{{url('/')}}">
            <img alt="Logo" src="{{ asset('img/logo-8.png') }}" class="kt-header__brand-logo-default"/>
            <img alt="Logo" src="{{ asset('img/logo-8.png') }}" class="kt-header__brand-logo-sticky"/>          
        </a>        
    </div> 
</div>
<!-- end:: Brand -->            
...
<div class="kt-header__topbar">
    ...
    <div class="kt-header__topbar-item kt-header__topbar-item--user" >
        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,10px">
            ...
            <img alt="Pic" src="{{ asset('backend/assets/media/users/300_21.jpg') }}"/>         
   ...
   <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile ">
    <ul class="kt-menu__nav ">
        ...
        <li class="kt-menu__item  kt-menu__item<?php if(Request::segment(2)=="dashboard") echo "--active";  else echo"--rel"; ?> " aria-haspopup="true">
            <a href="{{ url('admin/dashboard')}}" class="kt-menu__link "><span class="kt-menu__link-text">Dashboard</span></a>
        </li>
        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(2)=="agents") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="{{ url('admin/agents')}}" class="kt-menu__link"><span class="kt-menu__link-text">Agents</span>
        </a>
        </li>
        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(2)=="wallet") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="{{ url('admin/wallet')}}" class="kt-menu__link"><span class="kt-menu__link-text">Wallet</span>
        </a>
        </li>
        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(2)=="bookings") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="{{ url('admin/bookings')}}" class="kt-menu__link"><span class="kt-menu__link-text">Bookings</span>
        </a>
        </li>
        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(2)=="media") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="{{ url('admin/media')}}" class="kt-menu__link"><span class="kt-menu__link-text">Media</span>
        </a>
        </li>
        <!-- <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(1)=="training") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="{{ url('training')}}" class="kt-menu__link"><span class="kt-menu__link-text">Training</span>
        </a>
        </li>
        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item<?php if(Request::segment(1)=="dev_score") echo "--active";  else echo"--rel"; ?>" aria-haspopup="true">
            <a href="{{ url('dev_score')}}" class="kt-menu__link"><span class="kt-menu__link-text">Development Plan</span>
        </a>
        </li> -->
