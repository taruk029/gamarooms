  ...
  <body>
    ...
    <div class="theme-hero-area">
      <div class="theme-hero-area-bg-wrap">
        <div class="theme-hero-area-bg" style="background-image:url({{ asset('frontend/img/adult-book-business-cactus-297755_1500x800.jpg' ) }});"></div>
                    ...
                    <div class="theme-login-box-inner">
                      <form class="theme-login-form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group theme-login-form-group">
                          <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email') }}" required autocomplete="email" onblur="javascript:check_status()" placeholder="Username"/>
                          @error('email')
    ...
    <script src="{{ asset('frontend/js/youtube-bg.js') }}"></script>
